...
#function for writing dataframe rows to  Excel
#if file exist it will start writing after the last row
def Convert_to_Excel(df,filename):
    ...
    file=r"D:\\Naveed\\Freelancing\\1. Upwork\\2. Work for Portfolio\\2. Jobs to be performed\\job06\\Final Programs\\Outputs\\"+filename+".xlsx"
...
#function to convert list of unfromatted to dictionaries into a structured format
#using above function, data frame is then converted to excel 
...
#Function to merge duplciate cells 
#For beautifying the excel format 

def Merge_cells(filename):
    import openpyxl

    # Load the Excel file
    workbook = openpyxl.load_workbook('D:\\Naveed\\Freelancing\\1. Upwork\\2. Work for Portfolio\\2. Jobs to be performed\\job06\\Final Programs\\Outputs\\'+filename+'.xlsx')
    ...
    for row in range(2, worksheet.max_row + 1):
        ...
        if value != current_value:
            ...
            if merge_start_row is not None and merge_end_row is not None:
                worksheet.merge_cells(f'B{merge_start_row}:B{merge_end_row}')
    ...
    workbook.save('D:\\Naveed\\Freelancing\\1. Upwork\\2. Work for Portfolio\\2. Jobs to be performed\\job06\\Final Programs\\Outputs\\'+filename+'.xlsx')
